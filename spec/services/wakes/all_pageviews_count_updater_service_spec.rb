...
RSpec.describe Wakes::AllPageviewsCountUpdaterService do
  ...
  before do
    ...
    allow(Wakes::AllPageviewsCountUpdaterService::GetPathCountsForDateRangeService).to receive(:new)
  ...
  describe '#update_path_counts' do
    ...
    it 'creates a new GetPathCountsForDateRangeService for each date range' do
      expect(Wakes::AllPageviewsCountUpdaterService::GetPathCountsForDateRangeService).to receive(:new)
...
RSpec.describe Wakes::AllPageviewsCountUpdaterService::GetPathCountsForDateRangeService do
